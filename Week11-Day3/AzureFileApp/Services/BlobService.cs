...
namespace BlobAPI.Services
{
    public class BlobStorageService : IBlobStorageService
    {
        ...
        public async Task UploadFile(FileUploadDto fileDto)
        {
            ...
            var blobClient = await GetBlobClientWithSas(fileDto.File.FileName);
        ...
        {
            string functionUrl = $"https://azurefunction-tharun.azurewebsites.net/api/generate-sas/{fileName}?code=SCt7jt9QUIWLIXwec230ZoYci740N5ViiCXOm18W4Vj-AzFuT_buKw==";
