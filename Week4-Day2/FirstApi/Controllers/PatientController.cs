...
// {
//     static List<Patient> paitents = new List<Patient>{
//         new Patient { Id = 1, Name = "Tharun", DoctorName = "Dr. House", Age = 30, Diagnosis = "All well"}
//     };

//     [HttpGet]
//     public ActionResult<IEnumerable<Patient>> GetGreet()
//     {
//         if (paitents.Count == 0)
//         {
//             return NoContent();
